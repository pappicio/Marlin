...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
	...
	//#define DEFAULT_Kp 12.71 //    da testare
	// #define DEFAULT_Ki 0.83  //   da testare
	// #define DEFAULT_Kd 48.40 //   da testare
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //#define DEFAULT_bedKp 37.49  // 
  //#define DEFAULT_bedKi 7.09   // 
  //#define DEFAULT_bedKd 132.25 // 
...
// DEFINE E0
  ...
  #define TMC_BAUD_RATE                     19200 // Reduced to improve software serial reliability
    ...
    #define Z_SERIAL_TX_PIN                   PA10  // WIFI IO0
    #define Z_SERIAL_RX_PIN                   PA10
    #define Z2_SERIAL_TX_PIN                  PA10  // WIFI IO1
    #define Z2_SERIAL_RX_PIN                  PA10  // WIFI IO1
    #define E0_SERIAL_TX_PIN                  PA9   // MAX31855 CS
    ...
    #define Z2_SERIAL_TX_PIN                  PC7   // WIFI IO1
    #define Z2_SERIAL_RX_PIN                  PC7   // WIFI IO1
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { probe_x, probe_y, probe_z }
#else
...
#define PROBING_MARGIN 20  // not 10 to avoid touch clips on bed
 ...
 */
  ...
  ///////////////////////////////////////////
  //enable both if use smart filament sensor!
#endif

#if ENABLED(SAPPHIRE_PLUS_SMART_RUNOUT)
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X GRIDMAX_POINTS
  #define GRID_MAX_POINTS_Y GRIDMAX_POINTS
...
#if EITHER(FLASH_EEPROM_EMULATION, SDCARD_EEPROM_EMULATION)  // Marlin need 4KB and reachable are only 2KB
...
#define PREHEAT_6_LABEL       "PLA+"
#define PREHEAT_6_TEMP_HOTEND 200
...
// Support for Adafruit NeoPixel LED driver
  ...
  #define NEOPIXEL_TYPE NEO_GRB // NEO_GRBW, NEO_RGBW, NEO_GRB, NEO_RBG, etc. four/three channel driver type (defined in Adafruit_NeoPixel.h)
