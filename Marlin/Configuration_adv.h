 ...
 */
#if ENABLED(SAPPHIRE_PLUS_AUTOFAN)
...
#define COOLER_AUTO_FAN_TEMPERATURE 40
...
// NUM_Z_STEPPERS is no longer needed: already defined in Conditionals_LCD.h 
  ...
  //#define INVERT_Z2_VS_Z_DIR             // Z2 direction signal is the opposite of Z
    ...
    #define Z2_USE_ENDSTOP   _ZMAX_   // Z2 endstop board plug. Don't forget to enable USE_*_PLUG. (USE_ZMAX_PLUG)
    ...
    #if ENABLED(Z_MULTI_ENDSTOPS)
      #define Z3_USE_ENDSTOP   _YMIN_ // YMAX already used by stock Endstop - Z3 endstop board plug. Don't forget to enable USE_*_PLUG.
    ...
    #if ENABLED(Z_MULTI_ENDSTOPS)
      #define Z4_USE_ENDSTOP   _XMAX_ // XMIN already used by stock Endstop - Z4 endstop board plug. Don't forget to enable USE_*_PLUG.
...
#else
  #define HOMING_BACKOFF_POST_MM { 10, 10, 5 }  // (mm) Backoff from endstops after homing
#endif
 ...
 */
  ...
  // After G34 (Mechanical Gantry Calibration), re-home Z (G28 Z) or just calculate it from the last probe heights?
...
//#define CALIBRATION_GCODE
  ...
  #define CALIBRATION_MEASUREMENT_RESOLUTION     0.02 // mm
...
//#define LCD_BACKLIGHT_TIMEOUT 30 // (s) Timeout before turning off the backlight
 ...
 // Add a Probe Z Offset calibration option to the LCD menu
   ...
   */
  #if ENABLED(SAPPHIRE_PLUS_NEOPIXEL)
    ...
    //#define NEO2_COLOR_PRESETS              // Enable a second NeoPixel Preset Color menu option
      ...
      #define LED_USER_PRESET_BRIGHTNESS 70  // User defined intensity
      ...
      #define NEO2_USER_PRESET_BRIGHTNESS 70	// User defined intensity
...
// LCD Print Progress options
  ...
  #define BINARY_FILE_TRANSFER  //verify
 ...
 */
  ...
  #define SHOW_SD_PERCENT  // Replace DOGM_SD_PERCENT
 ...
 */
  ...
  #define LIN_ADVANCE_K K_VALUE     // Unit: mm compression per 1mm/s extruder speed
 ...
 */
  ...
  // #define EXTRUDE_MAXLENGTH                650 // already defined in configuration.h - FILAMENT_CHANGE_UNLOAD_LENGTH must be less than or equal to EXTRUDE_MAXLENGTH
  // #define FILAMENT_CHANGE_UNLOAD_LENGTH    100 // already defined in configuration.h -  (mm) The length of filament for a complete unload.
